...
namespace Day05
{
	...
	public static partial class StingExtensions
	{
		public static StringStream ToStringStream(this string @this) => new(@this);
		public static string Append(this string @this, string other) => @this + other;
	}
}
