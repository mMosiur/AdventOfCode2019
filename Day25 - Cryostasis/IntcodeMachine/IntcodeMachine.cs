...
public partial class IntcodeMachine : ICloneable
{
	...
	public long RunToFirstOutput(CancellationToken? token = null)
	{
		long? output = Step();
	...
	public IEnumerable<long> RunYieldingOutput(CancellationToken? token = null)
	{
		bool finished = false;
		long output = 0;
		while (!finished)
