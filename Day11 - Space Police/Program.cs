...
namespace Day11
{
	class Program
	{
		...
		static void PaintHull(Dictionary<Point, Color> hullPanels, HullPaintingRobot robot)
		{
			bool finished = false;
			while (!finished)
			{
		...
		static char ToChar(Color color) => color switch
		{
			Color.Black => '.',
			Color.White => '#',
		...
		static void DisplayHull(Dictionary<Point, Color> hullPanels)
		{
